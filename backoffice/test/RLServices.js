function getOfflineServices(){
    $.getJSON('/api/services', function (jd) {
        ...
        mainZone.html('<table id="table"><tr><th>Name</th><th>Id</th><th>Location</th><th>Days of opening</th><th>Time of opening/th><th>Type</th><th>Info</th><th>Mail</th><th>Phone</th></tr>');
        ...
        mainZone.append('<button id="submit_butrel" type="button" onclick="createOfflineService()">SUBMIT</button></form>');
        ...
        mainZone.append('<button id="submit_remrel" type="button" onclick="deleteOfflineServices()">REMOVE SERVICE</button></form>');
        ...
        mainZone.append('<button id="update_butrel" type="button" onclick="updateOfflineService()">UPDATE</button></form>');
    });
};
